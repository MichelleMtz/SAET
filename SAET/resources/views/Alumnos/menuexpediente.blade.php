...
@section('contenido')
    ...
    <div class="container">
        <ul class="nav nav-tabs" role="tablist" id="myTab">
            ...
            <li class="nav-item" >
                <a class="nav-link @yield("active_DG")" id="home-tab" role="tab" data-toogle="tab" href="/Administrador/carreras">Datos Generales</a>
            </li>
            <li class="nav-item" >
                <a class="nav-link @yield("active_AA")"  role="tab" data-toogle="tab" href="/Administrador/puestos" >Antecedentes académicos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield("active_DF")" role="tab" data-toogle="tab" href="/Alumno/DatosFamiliares" >Datos familiares</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @yield("active_HE")" role="tab" data-toogle="tab" href="/Administrador/periodos" >Hábitos de estudio</a>
            </li>
            <li class="nav-item">
